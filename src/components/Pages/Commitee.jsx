    ...
    <main className="mains">
      ...
      <div className="advisory">
        ...
        <h3>
          ...
          <br />
          Lead, INWHIZZ IT Innovations, Dharwad / Assistant Professor, Computer
          Science, Govt. First Grade College, Dharwad, India.
        </h3>
        <h3>
        ...
        <h3>
          ...
          <br />
          Dept of computer science, Govt. college Nedumangad, Trivandrum 695541,
          Kerala.
        </h3>
        <h3>
          Mr. Sivasankar Subramanian,
          <br />
          Senior software engineer, Visa Inc, Bagmane world Technology Centre,
          Mahadevapura, Bengaluru.
        </h3>
        <h3>
          Dr. N. V. Poornima,
          <br />
          Assistant Professor, Department of computer science, Christ (Deemed to
        ...
        <h3>
          Dr. Nagarjun J,
          <br />
          Assistant Professor (Sr.G), PSG Institute of Technology and Applied
          Research, Coimbatore.
        </h3>
      </div>
      ...
      <div className="advisory">
        ...
        <h3>
          Dr. R. Ananda Kishore,
          <br />
          Faculty Member, Department of Computer Science, Stanford University,
          USA.
        </h3>
        <h3>
          Prof. Dr. Samiru Gayan,
          <br />
          Professor, Department of Computer Science & Engineering, University of
          Jaffna, Sri Lanka.
        </h3>
        <h3>
